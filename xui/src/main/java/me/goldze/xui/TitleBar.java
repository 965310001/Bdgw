...
import static me.goldze.xui.TitleBar.DefaultValues.MATCH_PARENT;
import static me.goldze.xui.TitleBar.DefaultValues.TYPE_CUSTOM_VIEW;
import static me.goldze.xui.TitleBar.DefaultValues.TYPE_IMAGE_VIEW;
import static me.goldze.xui.TitleBar.DefaultValues.TYPE_NONE;
import static me.goldze.xui.TitleBar.DefaultValues.TYPE_TEXT_VIEW;
import static me.goldze.xui.TitleBar.DefaultValues.WRAP_CONTENT;
...
public class TitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        if (rightType == TYPE_TEXT_VIEW) {
            ...
            rightTextSize = array.getDimension(R.styleable.TitleBar_rightTextSize_bar, DimenUtil.sp2px(context, DefaultValues.DEFAULT_TEXT_SIZE));
    ...
    interface DefaultValues {
        int DEFAULT_NONE_RES = 0;

        int DARK = 0;//default
        int LIGHT = 1;

        boolean FILL_STATUS_BAR = true;
        boolean SHOW_BOTTOM_LINE = true;
        boolean TITLE_MARQUEE = true;

        String DEFAULT_THEME_COLOR = "#ffffff";
        String DEFAULT_DIVIDER_COLOR = "#d8d8d8";
        String DEFAULT_TEXT_COLOR = "#222222";
        String DEFAULT_SUB_TEXT_COLOR = "#666666";

        int HEADER_HEIGHT = 56;
        int DEFAULT_PADDING = 16;
        int DEFAULT_DRAWABLE_PADDING = 4;
        int DEFAULT_TEXT_SIZE = 14;
        int DEFAULT_TITLE_TEXT_SIZE = 18;
        int DEFAULT_SUB_TITLE_TEXT_SIZE = 14;
        float DIVIDER_HEIGHT = 0.5f;

        int TYPE_NONE = 0;
        int TYPE_TEXT_VIEW = 1;
        int TYPE_IMAGE_VIEW = 2;
        int TYPE_CUSTOM_VIEW = 3;
